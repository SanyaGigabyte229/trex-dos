...
EXTERN_C const GUID GUID_NDIS_GEN_PHYISCAL_MEDIUM_EX;
...
EXTERN_C const GUID GUID_NDIS_RECEIVE_FILTER_HARDWARE_CAPABILITIES;
...
EXTERN_C const GUID GUID_NDIS_802_5_LOST_FRAMES;
